      ...
      <template v-if="isBalanced">
        <div id="staking_container">
          <div class="header-section">
            ...
            <span class="daily-tokens"
              ><p>
                Daily Tokens Distributed Amongst Stakers:
                <span class="fill"> {{ ror }} </span> $CESS
              </p></span
            >
          ...
          <div class="lock-section">
            <div class="slider-container">
              ...
              <div class="label">
                Locking Amount:
                <span class="fill">{{ lockNumber }} $CESS/BNB LP</span>
              </div>
            ...
            <div class="unlock-section">
              <div class="staked-info">
                <span
                  ><p>
                    Currently Staked:
                    <span class="fill"> {{ stakedAmount }} </span> CESS/BNB LP
                  </p></span
                >
                <span
                  ><p>
      ...
      <div v-show="shitcanInfoModal" class="info-container">
        <div class="header-section">
          ...
          <p>
            ...
            <br />
            HOW IS THIS FEE CALCULATED? CESS/BNB PCSv2 LP Shitcan - DAY 1 = 10% || DAY 365 = 1%
            <br />
            The moment someone puts their tokens into the shitcan, fee degeneration begins and continues throughout the entirety of a year. Beginning at 10% and ending at 1%.
            <br />
